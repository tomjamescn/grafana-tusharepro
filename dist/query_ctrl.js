    ...
    execute: function () {
      ...
      _export('GenericDatasourceQueryCtrl', GenericDatasourceQueryCtrl = function (_QueryCtrl) {
        ...
        function GenericDatasourceQueryCtrl($scope, $injector, uiSegmentSrv) {
          ...
          _this.target.code = _this.target.code || '000001.SZ';
          _this.target.field = _this.target.field || 'close';
          _this.target.target = _this.target.target || 'daily/000001.SZ';
          _this.target.api = _this.target.target.split('/')[0] || 'daily';
